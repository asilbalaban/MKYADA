...
const MENU_LABEL: Record<MenuAction, string> = {
  ...
  layer_a: "Go to layer A",
  layer_b: "Go to layer B",
  layer_c: "Go to layer C",
  layer_d: "Go to layer D",
  layer_e: "Go to layer E",
  layer_f: "Go to layer F",
  layer_g: "Go to layer G",
  layer_h: "Go to layer H",
